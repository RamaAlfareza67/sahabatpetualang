    ...
    <header id="header">
    	<div class="container-fluid">
    		...
    		<nav id="nav-menu-container">
    			<ul class="nav-menu">
    				<li><a href="index.php?modul=panel/content&page=beranda">Home</a></li>
    				<li><a href="index.php?modul=panel/content&page=cara_beli">Cara Meminjam</a></li>         
    				<li class="menu-has-children">
    					...
    					<ul id="menu-has-children">
    						...
    						while($data_cat= mysqli_fetch_array($query_cat)){
    							echo "<li ><a id='menu' href='index.php?modul=panel/content&page=produk&id_category=$data_cat[id_category]'>$data_cat[nama_category]</a></li>";      
    						}
    						?>
    					</ul>
    				</li>
    				<li><a href="index.php?modul=panel/content&page=store_profile">Toko</a></li>
    		...
    		<div class="modal-dialog">
    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
    					<p>Kami dengan senang hati menyediakan berbagai macam peralatan outdoor, yang siap untuk memenuhi kebutuhan Petualangan anda.</p>
    				</div>
    				<!-- footer modal -->
  ...
  <!--==========================
    				...
    				<div class="carousel-item active">
    					...
    					<div class="carousel-container">
    						<div class="carousel-content">
    							<h2>Kamu mau berpetualang???</h2>
    							<p>Dengan rasa bangga kami menghadirkan alat-alat yang membantu kebutuhan petualangan anda, segera beli sekarang dan utamakan manajemen yang baik.</p>
    ...
    <main id="main">
    	...
    	<div class="content">
    		...
    		if (!isset($_GET['page'])) {
    			include ('panel/content/beranda.php');
    		} else {
    			$page = $_GET['page'];
    			$modul = $_GET['modul'];
    		...
    		<div class="container wow fadeIn">
    			<div class="row">
    				<div class="col-lg-16 text-center text-lg-center">
    					...
    					<p class="cta-text"><font size="4" color="black">"Bagi kamu yang mau liburan mari merapat karena sahabat petualang menyediakan berbagai macam peralatan Gunung."</font></p>
    				</div>
    			</div>
    		</div>
    	</div>
    	...
    	<section id="contact" class="section-bg wow fadeInUp">
    		<div class="container">
    			...
    			<center><p>Jangan ragu untuk bertanya apakah Anda memiliki pertanyaan tentang layanan kami atau Anda ingin membeli Peralatan yang dibutuhkan, kami akan senang mendengar dari Anda.</p></center>
    			<div class="row contact-info">
    				...
    				<div class="col-md-4">
    					<div class="contact-email">
    						...
    						<h3>Email</h3>
    						<p><a href="mailto:info@example.com">Ramaalfareza999@gmail.com</a></p>
    					</div>
    				</div>
    			</div>
    			...
    			<div class="form">
    				<form action="" method="post" enctype="multipart/form-data">
    					...
    					<div class="form-group">
    						<textarea class="form-control" name="mytextarea" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Masukkan Pesan"></textarea>
    						<div class="validation"></div>
    					</div>
  ...
  <!--==========================
    ...
    <footer id="footer">
      ...
      <div class="col-lg-3 col-md-6 footer-newsletter">
      	<h4>Subscribe</h4>
      	<p>Manfaatkan Email anda sebaik mungkin untuk mendapatkan informasi terbaru dan promo alat dari kami!</p>
