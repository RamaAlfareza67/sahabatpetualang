				...
				<div class="col-lg-4 col-md-8 portfolio-item"><br /><br />
					<div class="portfolio-wrap "><center><b><?php echo "$tampil[nama_produk]"; ?></b></center>
						...
						<div class="portfolio">
							...
							<a href="beranda.php" onclick="return confirm('Silahkan Login Untuk Peminjaman')" class="link-details" title="Pinjam"><img src="assets/img/keranjang.png" width="30" height="30"></a></center><br>
						</div>
					</div>
				</div>
				<?php
			...
			<nav class="text-center">
				<ul class="pagination">
					<?php if($halaman==1){
						...
						echo '<li><a href="index.php?modul=panel/content&page=produk&hal=';echo $halaman -1 ;echo '&id_category=';echo "$data_category[id_category]";echo '" aria-label="Previous"> <span aria-hidden="true">&laquo;</span> </a> </li>';
					}
					?>    
					<?php 
					for($x=1;$x<=$jmlhalaman;$x++){
						?>
						<li class="">
							<a href="index.php?modul=panel/content&page=produk&id_category=<?php echo "$data_category[id_category]"; ?>&hal=<?php echo $x ?>"><?php echo $x ?></a>
						</li>
						<?php
					}
					?>
