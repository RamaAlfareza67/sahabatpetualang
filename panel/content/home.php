				...
				<div class="col-lg-4 col-md-6 portfolio-item"><br /><br />
					<div class="portfolio-wrap "><center><b><?php echo "$tampil[nama_produk]"; ?></b></center>
						...
						<div class="portfolio">
							...
							<a href="beranda.php?modul=panel/content&page=detail_produk&id_produk=<?php echo "$tampil[id_produk]"; ?>&id_category=<?php echo "$tampil[id_category]"; ?>" class="link-details" title="Beli"><img src="assets/img/keranjang.png" width="30" height="30"></a></center><br>
						</div>
					</div>
				</div>
				<?php
			...
			<nav class="text-center">
				<ul class="pagination">
					<?php if($halaman==1){
						...
						echo '<li><a href="beranda.php?modul=panel/content&page=home&hal=';echo $halaman - 1 ;echo '" aria-label="Previous"> <span aria-hidden="true">&laquo;</span> </a> </li>';
					}
					?>    
					<?php 
					for($x=1;$x<=$jmlhalaman;$x++){
						?>
						<li class="">
							<a href="beranda.php?modul=panel/content&page=home&hal=<?php echo $x ?>"><?php echo $x ?></a>
						</li>
						<?php
					}
					?>
