      ...
      <nav class="text-center">
        <ul class="pagination">
         <?php if($halaman==1){
          ...
          echo '<li><a href="index.php?modul=panel/content&page=store_profile&halaman=';echo $halaman -1 ;echo '" aria-label="Previous"> <span aria-hidden="true">&laquo;</span> </a> </li>';
        }
        ?>    
        <?php 
        for($x=1;$x<=$jmlhalaman;$x++){
          ?>
          <li class="">
            <a href="index.php?modul=panel/content&page=store_profile&halaman=<?php echo $x ?>"><?php echo $x ?></a>
          </li>
          <?php
        }
        ?>
